...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customer/query.action" method="post">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="customerFrom" placeholder="客户来源" name="custSource">
								...
								<c:forEach items="${fromType}" var="item">
									...
									<%-- <c:if test="${item.dict_id==vo.custSource}">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/customer/query.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		function editCustomer(id) {
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/customer/toEdit.action",
				data:{"id":id},
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post(
					"${pageContext.request.contextPath}/customer/delete.action",
					{"id":id},
					function(data){
						alert("客户删除更新成功！");
						window.location.reload();
